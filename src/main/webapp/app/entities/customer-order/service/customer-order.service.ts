...
type RestOf<T extends ICustomerOrder | NewCustomerOrder> = Omit<T, 'createdDate'> & {
...
export class CustomerOrderService {
  ...
  protected convertDateFromClient<T extends ICustomerOrder | NewCustomerOrder | PartialUpdateCustomerOrder>(customerOrder: T): RestOf<T> {
    return {
      ...customerOrder,
      createdDate: customerOrder.createdDate?.toJSON() ?? null,
    };
  }
  ...
  protected convertDateFromServer(restCustomerOrder: RestCustomerOrder): ICustomerOrder {
    return {
      ...restCustomerOrder,
      createdDate: restCustomerOrder.createdDate ? dayjs(restCustomerOrder.createdDate) : undefined,
    };
  }

...
import { sampleWithRequiredData } from '../customer-order.test-samples';
...
describe('CustomerOrder Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.customerOrders()[0]).toEqual(expect.objectContaining({ id: 18791 }));
  });

  describe('trackId', () => {
    it('should forward to customerOrderService', () => {
      const entity = { id: 18791 };
      jest.spyOn(service, 'getCustomerOrderIdentifier');
      const id = comp.trackId(entity);
      expect(service.getCustomerOrderIdentifier).toHaveBeenCalledWith(entity);

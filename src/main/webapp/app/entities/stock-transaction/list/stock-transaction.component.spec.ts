...
import { sampleWithRequiredData } from '../stock-transaction.test-samples';
...
describe('StockTransaction Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.stockTransactions()[0]).toEqual(expect.objectContaining({ id: 10234 }));
  });

  describe('trackId', () => {
    it('should forward to stockTransactionService', () => {
      const entity = { id: 10234 };
      jest.spyOn(service, 'getStockTransactionIdentifier');
      const id = comp.trackId(entity);
      expect(service.getStockTransactionIdentifier).toHaveBeenCalledWith(entity);

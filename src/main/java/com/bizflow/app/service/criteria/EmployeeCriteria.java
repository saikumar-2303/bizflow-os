...
/**
 * Criteria class for the {@link com.bizflow.app.domain.Employee} entity. This class is used
 * in {@link com.bizflow.app.web.rest.EmployeeResource} to receive all the possible filtering options from
...
public class EmployeeCriteria implements Serializable, Criteria {
    ...
    public EmployeeCriteria(EmployeeCriteria other) {
        ...
        this.joiningDate = other.optionalJoiningDate().map(InstantFilter::copy).orElse(null);
    ...
    public Optional<InstantFilter> optionalJoiningDate() {
        return Optional.ofNullable(joiningDate);
    }

    public InstantFilter joiningDate() {
        if (joiningDate == null) {
            setJoiningDate(new InstantFilter());
        }
        return joiningDate;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, phone, designation, salary, joiningDate, active, distinct);
    }

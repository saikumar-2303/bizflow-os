...
import static com.bizflow.app.domain.OrderItemAsserts.*;
...
import com.bizflow.app.repository.OrderItemRepository;
import com.bizflow.app.service.OrderItemService;
import com.bizflow.app.service.dto.OrderItemDTO;
import com.bizflow.app.service.mapper.OrderItemMapper;
...
class OrderItemResourceIT {
    ...
    public static OrderItem createEntity() {
        return new OrderItem().quantity(DEFAULT_QUANTITY).price(DEFAULT_PRICE).totalAmount(DEFAULT_TOTAL_AMOUNT);
    }
    ...
    public static OrderItem createUpdatedEntity() {
        return new OrderItem().quantity(UPDATED_QUANTITY).price(UPDATED_PRICE).totalAmount(UPDATED_TOTAL_AMOUNT);
    }
    ...
    void putExistingOrderItem() throws Exception {
        ...
        updatedOrderItem.quantity(UPDATED_QUANTITY).price(UPDATED_PRICE).totalAmount(UPDATED_TOTAL_AMOUNT);
    ...
    void partialUpdateOrderItemWithPatch() throws Exception {
        ...
        partialUpdatedOrderItem.price(UPDATED_PRICE).totalAmount(UPDATED_TOTAL_AMOUNT);
    ...
    void fullUpdateOrderItemWithPatch() throws Exception {
        ...
        partialUpdatedOrderItem.quantity(UPDATED_QUANTITY).price(UPDATED_PRICE).totalAmount(UPDATED_TOTAL_AMOUNT);
